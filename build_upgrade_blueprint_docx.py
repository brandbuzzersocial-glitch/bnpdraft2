...
def build_upgrade_blueprint():
    ...
    pages_plan_summary = [
        ("1.0", "Home Page (index.html)", "Upgraded stats (2006-2026, 1.3M sq ft regional HQs), Founder Mr. Punam D. Kularia quote & vision, complete 20-year timeline, German precision machinery & ERP highlights, Taj Palace & Ayodhya landmark case studies, SOH magazine feature"),
